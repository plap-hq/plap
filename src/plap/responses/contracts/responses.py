...
class ResponseUsageInputTokensDetails(StrictModel):
    cached_tokens: int = Field(
        ge=0, description="Input tokens retrieved from prompt cache."
    )
...
class ResponseObject(StrictModel):
    ...
    output: list[ResponseOutputItem] = Field(
        description="Ordered output items generated by the model."
    )
    ...
    temperature: float | None = Field(
        default=None, ge=0, le=2, description="Sampling temperature used."
    )
    ...
    top_p: float | None = Field(
        default=None, ge=0, le=1, description="Nucleus sampling value used."
    )
...
class CompactedResponseObject(StrictModel):
    ...
    output: list[ResponseOutputItem] = Field(
        description="Compacted output items from the compaction pass."
    )
...
class InputItemsPage(StrictModel):
    ...
    first_id: str | None = Field(
        default=None, description="First item ID in this page."
    )
