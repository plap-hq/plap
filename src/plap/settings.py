    ...
    return {
        "plap-ai/wisp-mini": RuntimeModelProfileConfig(
            ...
            main=RuntimeActorConfig(
                model="qubrid/deepseek-ai/DeepSeek-V4-Flash,openrouter/deepseek/deepseek-v4-flash:novita,openrouter/deepseek/deepseek-v4-flash:atlas-cloud",
        ...
        "plap-ai/wisp": RuntimeModelProfileConfig(
            ...
            main=RuntimeActorConfig(
                model="crof/mimo-v2.5-pro-precision,openrouter/xiaomi/mimo-v2.5-pro:xiaomi,gmicloud/XiaomiMiMo/MiMo-V2.5-Pro",
